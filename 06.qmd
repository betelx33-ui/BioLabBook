...
-   Axial \_All bones except arms and legs\_
-   Appendicular skeleton \_All bones except skull, thorax, or spine\_

**General Structure of Long Bones** - See description in the textbook.

-   Epiphysis \_rounded protruding end of a long bone. made of spongy bone\_
-   Diaphysis \_mid section of long bone\_
-   Compact bone \_dense, hard, outer layer of bone\_
-   Spongy bone \_pourous bone found in interior and at the ends of long bones\_
-   Hyaline (articular) cartilage \_common, glassy connective tissue made of collagen and condrocytes\_
-   Periosteum \_fibrous connective membrane on most bones\_
-   Bone processes \_\_projections of bone that provide attachment points for tendons and ligaments\_\_
-   Medullary cavity \_central hollow space of diaphysis of long bones, lined with endosteum and filled with yellow marrow\_
-   Yellow marrow \_connective tissue found in medullary cavity\_
-   Red marrow \_connective tissue found in center of bone, makes red blood cells\_
-   Epiphyseal plate \_cartilage layer in metaphysis at long bone ends in kids, important for long bone growth\_
-   Endosteum (simple squamous) \_\_vascular membrane lining inner bone\_\_

**Bone Tissue**

| Term | Definition |
|------------------------------------|------------------------------------|
| Osteocytes | majority of mature bone cells, come from osteoblasts |
| Matrix | non-living bone material that forms framework |
| Collagen fibers | strong protein fibers that are the main part of connective tissue |
| Calcium phosphate | crystalline minerals in bone |
...
|------------------------------------|------------------------------------|
| Long honos |  |
| Long bones | dense elongated bones |
| Short bones | primarily used in hands and feet |
| Flat bones | protect organs, consist of 2 flat bones with sponge bone inbetween |
| Irregular | too complex to fit in categories |
| Sesamoid bones | small bones embedded in tendons or muscles. |
...
|------------------------|------------------------|------------------------|
| Long | Cylindrical shape; longer than wide | Humerous |
| Short | Cube shaped length, width, and thickness; relatively equal | Meta carpels |
| Flat | Thin and wide curved | Skull bones |
| Irregular | Complex shape | Vertebral column |
...
-   **4** A bony bulb or structure on a narrow neck is called a(n) \_Head\_. (4)

-   **6** On a bone, a(n) \_Process\_ is a structure which protrudes from a bone. These are often named for what they protrude toward. (7)

-   **7** On the femur, a(n) \_perforating canal\_ refers to a large, blunt, unevenly shaped process. (10)

-   **8** A sharp, axe-like or needle-like projection on a bone is called a(n) Spine\_. (5)

### **Down**

-   **1** On a bone, a(n) \_\_Fissure\_ is a deep groove or notch. (7)

-   **2** The flat, smooth face on a bone where it meets another bone is called a(n) \_Facet\_. (5)

-   **3** On a bone, a(n) \_Crest\_ is a narrow ridge. A(n) \_line\_ is a smaller version. (5,4)

-   **5** A raised area on a condyle is called a(n) \_Epicondyle\_. (10)
...
**6** Compact bone consists of long, multi-layered cylinders called \_Osteons\_, surrounded by a central, blood-vessel and nerve-containing canal called the \_Haversian Canals. (7,9,6)

**7** Blood vessels and nerves may move from one Haversian canal to another by detouring through a(n) \_perforating canal\_. (11,5)

### **Down**

**1** Mature bone cells are called \_fissure\_ (10)

**2** Young, dividing cells usually have names that end in \_\_blasto\_; mature cells usually have names that end in \_cyte\_. (10)

**3** Osteocytes in lacunae within an osteon maintain contact with one another by extending processes through \_Canalculi\_. (10)

**4** Cells that dissolve bone are called \_Osteoclasts\_. (11)

**5** Bone-building cells are called \_Osteoblasts\_. (10)
