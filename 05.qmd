...
| Stratum corneum | top layer of epidermis is made of dead keratinocytes |
| Stratum lucidum | appears as glassy layer only in thick skin |
| Stratum granulosum | contain keratinocytes |
| Stratum spinosum | kerotinocytes bound together in desmosomes |
| Stratum basale (germinitivum) | deepest epidermal layer, attaches to basement layer |
| Dermal Layer | middle thick layer of skin |

**Dermal Layer**

| Term | Definition |
|----|----|
| Dermis | middle thick layer of skin that supports epidermis |
| Papillary layer | consists of areolar tissue, capillaries, and lymphatic vessels to support epidermis |
| Reticular layer | consists of dense irregular connective tissue |

| Term | Definition |
|----|----|
| Subcutaneous Layer (Hypodermis) | connects dermis to underlying connective tissue |

**Integumentary Structures**

| Term | Definition |
|----|----|
| Dermal papillae | specialized cluster of cells located at base of follicle that is primary signal center to regulate follicle |
| Hair shaft | parts of hair that protrudes out of skin |
| Hair root | structure of connective tissue papilla and layer of epithelial cells that produce shaft |
| Hair follicle | accessory structure that begins at surface and ends at papilla |
| Pore | tunnel structure hair grows out of |
| Arrector pili muscle | muscles that cause hair to erect |
| Sebaceous gland | scretes sebum to inhibit bacteria and moisterize hair |
| Merocrine (eccrine) sweat gland | secretes sweat onto skin for cooling |
| Apocrine sweat gland | secrets in armpits and smells bad |
| Free nerve ending | specialized nerve that transmits stimuli |
| Meissner's (tactile) corpuscle | receptor in dermal papillae to detect low vibrations |
| Pacinian (pressure) corpuscle | receptor in deep skin to detect high frequencies |
| Keratinocyte | primary cell of epidermis, which forms protective layer of skin |
| Melanocyte | cell that distributes pigment of skin |
...
-   15: \_sebaceous gland\_
-   21: \_pacinian corpuscle\_
-   14: \_arrector pili muscle\_
-   20: \_eccrine sweat gland\_
...
|----|----|
| Stratum corneum | layer of flat dead keratinocytes that is waterproof and most sturdy |
| Stratum lucidum | glass layer only in thick skin |
| Stratum granulosum | live keratinocytes |
| Stratum spinosum | full of keratinocytes bound by desmosomes, immune cells, dendrites |
| Stratum basale (germinitivum) | deepest, attached to basement membrane, has stem cells |
...
|----|----|
| Dermal papillae | primary hair command |
| Pore | exit for sebum and sweat |
| Arrector pili muscle | muscles that erect hair |
| Sebaceous gland | sebum producer |
| Merocrine (eccrine) sweat gland | releases water |
| Apocrine sweat gland | releases creamy sweat from armpits |
| Free nerve ending | detects pain, temperature, itch |
| Meissner's (tactile) corpuscle | tactile feel, used for gripping, superficial |
| Pacinian (pressure) corpuscle | deep skin feel, detects pressure, and high vibrations |
| Keratinocyte | keratinized skin cell |
...
sebaceus gland: secretes sebum. meccrine: releases sweat. Apocrine: releases ilky sweat in arm pits\
\
\

-   What are the three protective functions of the integumentary system?

immune defense, tissue defense, UV defense\
\
\
...
| 7 m | Hair follicle | g\. A type of nerve ending in the skin that is responsible for sensitivity to pressure |
| 8 d | Dermal papillae | h\. The small smooth muscles associated with the base of each hair that contract when the body surface is chilled and erect the hairs |
...
|----|----|----|
| a\. simple epithelial tissue | The epidermis is composed of \_\_\_\_\_\_\_\_\_\_. | Hair bulb |
...
| e.dendritic cells | Immune cells in the stratum spinosum which protect against invaders are the \_\_\_\_\_\_\_\_\_\_. | root |
...
| i.pacinian corpsucles | The reticular layer of the dermis contains \_\_\_\_\_\_\_\_\_\_ to sense firm pressure. | papillary layer; reticular layer |
| j\. sudorifous | Apocrine and eccrine glands are both \_\_\_\_\_\_\_\_\_\_ (sweat) glands. | keratinocytes; keratin |
...
| l\. shaft | The portion of the hair that is above the surface of the skin is called the \_\_\_\_\_\_\_\_\_\_. | Stratum corneum |
...
\
skin is caused by carotene pigment from the vegetables they ate\
\
...
The merocrine sweat glands cools body by secreting water for evaporation\
\
\

-   How would you explain why a light skinned individual would be more susceptible to malignant melanoma?

Their melanin concentration is less dense so it's easier for UV radiation to affect them\
\
\
...
|-----|----------------------------------------------------------------------|
| a\) | immunity                                                             |
| b\) | abrasion protection                                                  |
| c\) | UV radiation protection                                              |
