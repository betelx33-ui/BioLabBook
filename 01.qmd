...
| Superior (or cranial) | higher                    |     |
| Inferior (or caudal)  | lower                     |     |
| Lateral               | away from middle          |     |
| Medial                | toward longitudinal axis  |     |
...
| Term        | Definition                                            |
|-------------|-------------------------------------------------------|
| Cranial     | inside skull                                          |
| Abdominal   | contains digestive organs                             |
| Pericardial | contains heart                                        |
| Pleural     | contains lungs                                        |
| Ventral     | Divided into the thoracic and abdominopelvic cavities |
...
| Term                     | Definition                                                |
+==========================+===========================================================+
| Sagittal plane           | parallel to long axis, splits the right and left portions |
+--------------------------+-----------------------------------------------------------+
| Midsagittal plane        | splits into left and right halves                         |
+--------------------------+-----------------------------------------------------------+
| Parasagittal plane       | splits into uneven left and right                         |
+--------------------------+-----------------------------------------------------------+
| Frontal plane            | splits anterior and posterior                             |
+--------------------------+-----------------------------------------------------------+
...
+================================+========================+=====================+
| 1 integumentary                | superficial protection | skin, hair, nails   |
+--------------------------------+------------------------+---------------------+
| 2 skeletal                     | structure              | bones               |
+--------------------------------+------------------------+---------------------+
| 3 muscular                     | movement               | muscles, tendons    |
+--------------------------------+------------------------+---------------------+
| 4 nervous                      | body control           | brain, spine nerves |
+--------------------------------+------------------------+---------------------+
| 5 endocrine                    | hormonal control       | glands, pancreas    |
+--------------------------------+------------------------+---------------------+
| 6 cardiovascular               | transport              | heart, veins        |
+--------------------------------+------------------------+---------------------+
| 7 lymphatic                    | immune support         | thymus, lymph nodes |
+--------------------------------+------------------------+---------------------+
| 8 respiratory                  | gas exchange           | lungs               |
+--------------------------------+------------------------+---------------------+
| 9 digestive                    | nutrient absorption    | stomach, intestines |
+--------------------------------+------------------------+---------------------+
| 10 urinary                     | waste excretion        | kidneys             |
+--------------------------------+------------------------+---------------------+
| 11a male reproductive system   | reproduction           | penis, testes       |
+--------------------------------+------------------------+---------------------+
| 11b female reproductive system | reproduction           | vagina ovaries      |
+--------------------------------+------------------------+---------------------+
...
| \#      | Fill in the blank                                                                                                                                                                               |
+=========+=================================================================================================================================================================================================+
| 1       | The elbow is located superior to the wrist.                                                                                                                                                     |
+---------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2       | The umbilicus is located \_inferior\_ to the sternum.                                                                                                                                           |
+---------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3       | The nose is located \_anterior and medial\_ to the ears.                                                                                                                                        |
+---------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4       | The mouth is located \_superior\_ to the chin.                                                                                                                                                  |
+---------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5       | A papercut that does not penetrate the skin would be considered as a \_superficial\_ wound; however, a puncture wound from a nail penetrating the skin would be considered as a \_deep\_ wound. |
+---------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| Left upper quadrant  | stomach, large intestine            |
| Left lower quadrant  | small intestine, urinary bladder    |
...
| umbilical           | gallbladder, large int, small int |
| right lumbar        | large int                         |
| left iliac          | large int                         |
| hypogastric         | lar int, urinary, bladder         |
| right iliac         | large int                         |
...
-   The \_integumentary\_ system forms the external body covering.
-   The \_\_muscular\_ system protects deeper tissues from injury.
-   The \_integumentary\_ system synthesizes vitamin D.
-   Organs of the \_endocrine\_ system secrete chemicals called hormones into the blood.
-   The \_respiratory\_ system keeps blood supplied with oxygen and disposes of unwanted carbon dioxide.
-   The \_reproductive\_ system produces sperm or eggs and sex hormones.

### Homeostasis

-   In a(n) \_positive\_ feedback system, a change in a condition is sensed and amplified.
-   In a(n) \_\_\_negative feedback\_ feedback system, a change in a condition is sensed and returned toward its previous level.

### Position terms review:

-   The knees are \_superior\_ to the ankles.
-   The thumbs are \_posterior\_ to the pinky fingers.
-   The spine is \_medial\_ to the breastbone.
-   The chest is \_lateral\_ to the shoulder blades.
-   The pinky fingers are \_superior\_ to the thumbs.
-   The navel is \_inferior\_ to the lower back.
-   The eyes are \_\_inferior\_\_ to the bridge of the nose.
-   The breasts are \_anterior\_ to the lungs.
...
-   "Nasal" refers to the \_nose\_.
-   "Oral" refers to the \_mouth\_.
-   "Cervical" refers to the \_neck\_.
-   "Acromial" refers to the \_top of shoulder\_.
-   "Axillary" refers to the \_armpit\_.
-   "Abdominal" refers to the \_ads\_.
-   "Brachial" refers to the \_\_arm\_\_.
-   "Antecubital" refers to the \_\_front elbow\_.
-   "Antebrachial" refers to the \_\_forearm\_\_.
-   "Pelvic" refers to the \_\_pelvis\_\_.

### Planes

-   The \_\_frontal\_ or \_\_coronal\_\_ plane separates the anterior and posterior portions of an object
-   The \_transverse\_\_or \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ plane separates the superior and inferior portions of an object.

### Cavities

-   The cranial cavity is within the \_\_skull \_\_ cavity.
-   The spinal or vertebral cavity is within the \_\_\_dorsal\_ cavity.
-   The thoracic cavity is within the \_\_\_\_ventral\_\_\_ cavity.
-   The abdominopelvic cavity is within the \_\_ventral \_ cavity.
-   The brain is found in the \_\_cranial\_\_ cavity. Use the most specific, i.e., smallest cavity that is appropriate.
-   The spinal cord is found in the \_\_vertebral\_ cavity. Use the most specific, i.e., smallest cavity that is appropriate.
...
2.  The diaphragm separates the:
    ...
    b.  Thoracic and abdominal cavities 1
