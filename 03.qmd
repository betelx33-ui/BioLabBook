...
| Term       | Definition                |
|------------|---------------------------|
| Cytoplasm  | jelly filling of cell     |
| Cytosol    | aqueous part of cytoplasm |
| Organelles | subunits of cell          |
...
| Golgi apparatus | vesicle complex |
| Mitochondrion | power house |
| Lysosomes | contains breakdown enzyme |
| Peroxisomes | contains catalase and oxidase |
| Microfilaments | thinnest part of cytoSKELETON |
| Microtubules | tubes that eukary cells use to hold cell shape |
| Cilia | hair like structure of cells that vibrate |
| Flagella | tail structure that propels cells |
| Nucleus | central DNA core |
| Nucleolus | small DNA structure in the nucleus that synthesizes ribosomes |

### **Membrane Transport**

-   Passive Transport \_zero energy transport from higher to lower concentration\_
-   Active Transport \_energy-dependent transport moving things from lower to higher concentration\_
-   Diffusion \_passive movement from higher to lower concentration\_
-   Osmosis \_passive movement of water from higher solute concentration to lower\_
-   Cell Cycle \_ordered and regulated cell sequence\_\_
-   Interphase \_longest and most active phase of eukary cell cycle\_
-   Mitosis \_\_cycle of cell division\_

### **Stages of Interphase and Mitosis**

-   Interphase \_most active phase of eukary cell divison\_
-   G1 phase \_first and longest part of interphase, after mitosis, before s phase\_
-   S phase \_occurs between G1 and G2, replicates DNA\_
-   G2 phase \_final subphase of interphase, occurs after S phase and before M phase, rapid cell growth and organelle creation\_
...
|------------------------|------------------------|------------------------|
| Prophase | dissolution of nucleas, chromosome condensation, and centrioles make spindle |  |
| Metaphase | chromosomes are arranged on cell midline |  |
| Anaphase | chromosomes splits and move to opposite ends |  |
| Telophase | nuclei form, chromosomes loosen to chromatin |  |
| Cytokinesis | split of cytoplasm into daughter cells |  |
...
|----|----|----|
| Plasma membrane | separates cell interior from outside |  |
| Cilia |  |  |
| Microvilli |  |  |
| Nucleolus |  |  |
| Nucleus |  |  |
...
1.  The smallest independent unit that is alive is the \_cell\_.
2.  The region in a human cell that houses the bulk of the genetic material is the \_nucleus\_.
3.  Most of the cellular machinery in human cells is in the cytoplasm.
4.  The basic structure of a cell's membrane is a lipid bilayer with associated proteins that can be either integral or peripheral.
...
| 8\) \_b\_ Cytokinesis | h\) Observed when the chromosomes move toward opposite ends of the nuclear spindle |  |
| 9\) \_j\_ Telophase | i\) Occurs when the cell's chromosomes condense and move together, aligning in the center of the dividing cell. |  |
| 10\) \_h\_ Anaphase | j\) The final stage in cell division |  |
